...
class AnswerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('IkasiBundle:Answer')->findAll();

        return $this->render('IkasiBundle:Answer:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('IkasiBundle:Answer:new.html.twig', array(
            'entity' => $entity,
    ...
    private function createCreateForm(Answer $entity)
    {
        $form = $this->createForm(new AnswerType(), $entity, array(
            'action' => $this->generateUrl('admin_answer_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('IkasiBundle:Answer')->find($id);
        ...
        return $this->render('IkasiBundle:Answer:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('IkasiBundle:Answer:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    {
        $form = $this->createForm(new AnswerType(), $entity, array(
            'action' => $this->generateUrl('admin_answer_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_answer_delete', array('id' => $id)))
            ->setMethod('DELETE')
